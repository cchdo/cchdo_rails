   ...
   def csv_dump
      ...
      if @assignments
         ...
         CSV::Writer.generate(report, ',') do |csv|
            csv << ['ExpoCode','Project', 'CurrentStatus','AssignedTo','DataContact', 'Action','Parameter', 'Priority', 'Deadline','Last Changed', 'Notes','History']
            @assignments.each do |task|
               csv << [task.ExpoCode, task.project, task.current_status,  task.cchdo_contact, task.data_contact, task.action, task.parameter, task.priority, task.deadline, task.last_changed, task.notes, task.history]
            end
         end
         report.rewind
