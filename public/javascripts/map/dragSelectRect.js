...
function DragSelectRectControl(opts_boxStyle, opts_other, opts_callbacks) {
...
DragSelectRectControl.prototype = new GControl();
 ...
 */
DragSelectRectControl.prototype.saveMapContext = function(text) {
 ...
 */
DragSelectRectControl.prototype.initiateSelect = function() {this.buttonclick_()};

/**
 * Initiate a dragSelect back operation as if the user had.
 * Back Button functionality:	
 */
DragSelectRectControl.prototype.initiateSelectBack = function() {if (this.globals.options.backButtonEnabled) this.backbuttonclick_()};	
 ...
 */
DragSelectRectControl.prototype.initButton_ = function(buttonContainerDiv) {
  var G = this.globals;
 ...
 * @param {DOM Node} buttonContainerDiv created in main .initialize code
 */
DragSelectRectControl.prototype.initBackButton_ = function(buttonContainerDiv) {
  var G = this.globals;
 ...
 */
DragSelectRectControl.prototype.setButtonMode_ = function(mode){
  var G = this.globals;
  if (mode == 'selecting') {
 ...
 * @param {GMap2} map The map that has had this DragSelectRectControl added to it.
 * @return {DOM Object} Div that holds the gselectcontrol button
 */ 
DragSelectRectControl.prototype.initialize = function(map) {
  var G = this.globals;
  var me = this;
 ...
 */
DragSelectRectControl.prototype.getDefaultPosition = function() {
 ...
 * @param {Object} e 
 */
DragSelectRectControl.prototype.coverMousedown_ = function(e){
  var G = this.globals;
  G.draggingOn = true;
  this.unmark_();
 ...
 * @param {Object} e 
 */
DragSelectRectControl.prototype.drag_ = function(e){
  var G = this.globals;
  if(G.draggingOn) {
    var pos = this.getRelPos_(e);
 ...
 * @param {Event} e
 */
DragSelectRectControl.prototype.mouseup_ = function(e){
  var G = this.globals;
  if (G.draggingOn) {
    G.draggingOn = false;
 ...
 */
DragSelectRectControl.prototype.mark_ = function(bounds) {
  var G = this.globals;
...
DragSelectRectControl.prototype.unmark_ = function() {
	var G = this.globals;
	if (G.marker != null) {
 ...
 */
DragSelectRectControl.prototype.setDimensions_ = function() {
  var G = this.globals;
 ...
 */
DragSelectRectControl.prototype.initStyles_ = function(){
  var G = this.globals;
 ...
 */
DragSelectRectControl.prototype.buttonclick_ = function(){
  var G = this.globals;	
  G.backButtonDiv.style.display='none';
 ...
 */
DragSelectRectControl.prototype.backbuttonclick_ = function(){
  var G = this.globals;	
 ...
 */
DragSelectRectControl.prototype.saveBackContext_ = function(text,methodCall) {
  var G = this.globals;
  var backFrame = {};
 ...
 */
DragSelectRectControl.prototype.restoreBackContext_ = function() {
  var G = this.globals;
 ...
 */
DragSelectRectControl.prototype.initCover_ = function(){
  var G = this.globals;
 ...
 * @param {Object} e
 */
DragSelectRectControl.prototype.getRelPos_ = function(e) {
 ...
 */
DragSelectRectControl.prototype.getRectangle_ = function(startX, startY, currPos, ratio){
 ...
 */
DragSelectRectControl.prototype.resetDragSelect_ = function() {
  var G = this.globals;
